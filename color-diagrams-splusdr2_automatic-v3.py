'''
Read the file (two) from S-PLUS DR2 to make the colour-colour diagrams
'''
...
cmd_args = parser.parse_args()
fitsfile1 = cmd_args.fileName1 + ".fits"
...
#########################################################################
#Color vironen
x1_MAG_APER_aper1, y1_MAG_APER_aper1 = colour(tab_1, 'R_aper_3', 'I_aper_3', 'R_aper_3', 'F660_aper_3')
colours1["r-i"] = x1_MAG_APER_aper1
colours1["r-ha"] = y1_MAG_APER_aper1
#Color
x2_MAG_APER_aper1, y2_MAG_APER_aper1 = colour(tab_1, 'F515_aper_3', 'F861_aper_3', 'F515_aper_3', 'F660_aper_3')
colours1["F515 - F861"] = x2_MAG_APER_aper1
colours1["F515 - F660"] = y2_MAG_APER_aper1
#Color
x3_MAG_APER_aper1, y3_MAG_APER_aper1 = colour(tab_1, 'Z_aper_3', 'G_aper_3', 'Z_aper_3', 'F660_aper_3')
colours1["z - g"] = x3_MAG_APER_aper1
colours1["z - F660"] = y3_MAG_APER_aper1
#Color
x4_MAG_APER_aper1, y4_MAG_APER_aper1 = colour(tab_1, 'F660_aper_3', 'R_aper_3', 'G_aper_3', 'F515_aper_3')
colours1["F660 - r"] = x4_MAG_APER_aper1
colours1["g - F515"] = y4_MAG_APER_aper1
#Color
x5_MAG_APER_aper1, y5_MAG_APER_aper1 = colour(tab_1, 'G_aper_3', 'I_aper_3', 'F410_aper_3', 'F660_aper_3')
colours1["g - i"] = x5_MAG_APER_aper1
colours1["F410 - F660"] = y5_MAG_APER_aper1
#########################################################
#ERROR ##################################################
#########################################################
#Error Color vironen
ex1_MAG_APER_aper1, ey1_MAG_APER_aper1 = errormag(tab_1, 'e_R_aper_3', 'e_I_aper_3', 'e_R_aper_3', 'e_F660_aper_3')
colours1["e(r-i)"] = ex1_MAG_APER_aper1
colours1["e(r-ha)"] = ey1_MAG_APER_aper1
#Color
ex2_MAG_APER_aper1, ey2_MAG_APER_aper1 = errormag(tab_1, 'e_F515_aper_3', 'e_F861_aper_3', 'e_F515_aper_3', 'e_F660_aper_3')
colours1["e(F515 - F861)"] = ex2_MAG_APER_aper1
colours1["e(F515 - F660)"] = ey2_MAG_APER_aper1
#Color
ex3_MAG_APER_aper1, ey3_MAG_APER_aper1 = errormag(tab_1, 'e_Z_aper_3', 'e_G_aper_3', 'e_Z_aper_3', 'e_F660_aper_3')
colours1["e(z - g)"] = ex3_MAG_APER_aper1
colours1["e(z - F660)"] = ey3_MAG_APER_aper1
#Color
ex4_MAG_APER_aper1, ey4_MAG_APER_aper1 = errormag(tab_1, 'e_F660_aper_3', 'e_R_aper_3', 'e_G_aper_3', 'e_F515_aper_3')
colours1["e(F660 - r)"] = ex4_MAG_APER_aper1
colours1["e(g - F515)"] = ey4_MAG_APER_aper1
#Color
ex5_MAG_APER_aper1, ey5_MAG_APER_aper1 = errormag(tab_1, 'e_G_aper_3', 'e_I_aper_3', 'e_F410_aper_3', 'e_F660_aper_3')
colours1["e(g - i)"] = ex5_MAG_APER_aper1
colours1["e(F410 - F660)"] = ey5_MAG_APER_aper1

print("Number of objects in File 1 (PNe) is:", len(colours0["e(F410 - F660)"]))
print("Number of objects in File 2 (H II regions) is:", len(colours1["e(F410 - F660)"]))
...
ax.scatter(colours1["r-i"], colours1["r-ha"], c=sns.xkcd_rgb['light orange'], alpha=0.7, marker ='o', s=100, zorder=21.0, label='Compact HII regions')
...
plt.tight_layout()
pltfile = 'Fig1-{}-{}-vironen.pdf'.format(fitsfile.split('.fit')[0], fitsfile1.split('.fit')[0])
...
ax1.scatter(colours1["F515 - F861"], colours1["F515 - F660"], c=sns.xkcd_rgb['light orange'], alpha=0.7, marker ='o', s=100, zorder=21.0, label='PN candidate')
...
#ax1.grid()
plt.tight_layout()
pltfile = 'Fig2-{}-{}-J0515_J0660.pdf'.format(fitsfile.split('.fit')[0], fitsfile1.split('.fit')[0])
...
ax2.scatter(colours1["z - g"], colours1["z - F660"], c=sns.xkcd_rgb['light orange'], alpha=0.7, marker ='o', s=100,  zorder=21.0)
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'Fig3-{}-{}-z.pdf'.format(fitsfile.split('.fit')[0], fitsfile1.split('.fit')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
###############################################################
...
ax4.scatter(colours1["F660 - r"], colours1["g - F515"], c=sns.xkcd_rgb['light orange'], alpha=0.7, marker ='o', s=100, zorder=21.0)
...
#sns.despine(bottom=True)
plt.tight_layout()
pltfile = 'Fig4-{}-{}-g.pdf'.format(fitsfile.split('.fit')[0], fitsfile1.split('.fit')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
...
ax5.scatter(colours1["g - i"], colours1["F410 - F660"], c=sns.xkcd_rgb['light orange'], alpha=0.7, s=100,  zorder=21.0)
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'Fig5-{}-{}-gi.pdf'.format(fitsfile.split('.fit')[0], fitsfile1.split('.fit')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
