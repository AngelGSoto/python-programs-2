...
plt.tight_layout()
pltfile = 'figs-pca/Fig1-{}-vironen.pdf'.format(file_.split('.ta')[0])
...
#ax1.grid()
plt.tight_layout()
pltfile = 'figs-pca/Fig2-{}-J0515_J0660.pdf'.format(file_.split('.ta')[0])
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca/Fig3-{}-z.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
###############################################################
...
#sns.despine(bottom=True)
plt.tight_layout()
pltfile = 'figs-pca/Fig4-{}-g.pdf'.format(file_.split('.tab')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca/Fig5-{}-gi.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
...
#sns.despine(bottom=True)
plt.tight_layout()
pltfile = 'figs-pca/Fig1-{}-vironen-auto.pdf'.format(file_.split('.ta')[0])
# save_path = '../../../../../Dropbox/paper-pne/Fig/'
# file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
#############################################################################################
...
#ax7.grid()
plt.tight_layout()
pltfile = 'figs-pca/Fig2-{}-J0515_J0660-auto.pdf'.format(file_.split('.ta')[0])
#save_path = '../../../../../Dropbox/JPAS/paper-phot/'
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca/Fig3-{}-z-auto.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
###############################################################
...
#sns.despine(bottom=True)
plt.tight_layout()
pltfile = 'figs-pca/Fig4-{}-g-auto.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca/Fig5-{}-gi-auto.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
