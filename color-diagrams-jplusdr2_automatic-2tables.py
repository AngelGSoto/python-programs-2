...
parser.add_argument("fileName1", type=str,
                    default="teste-program",
                    help="Name of table 2, taken the prefix ")

cmd_args = parser.parse_args()
file_ = cmd_args.fileName + ".tab"

cmd_args = parser.parse_args()
fitsfile1 = cmd_args.fileName1 + ".tab"
...
nsourse1 = len(fitsfile1)
colours1 = {c: [np.empty((nsourse1,))] for c in col_names}
colours1_auto = {c: [np.empty((nsourse,))] for c in col_names}
...
tab_1 = Table.read(ROOT_PATH / fitsfile1, format="ascii.tab")
...
#########################################################
#Error Color vironen
ex1_MAG_APER_auto, ey1_MAG_APER_auto = errormag(tab_1, 'rSDSS_auto_err', 'iSDSS_auto_err', 'rSDSS_auto_err', 'J0660_auto_err')
colours_auto["e(r-i)"] = ex1_MAG_APER_auto
colours_auto["e(r-ha)"] = ey1_MAG_APER_auto
#Color
ex2_MAG_APER_auto, ey2_MAG_APER_auto = errormag(tab_1, 'J0515_auto_err', 'J0861_auto_err', 'J0515_auto_err', 'J0660_auto_err')
colours_auto["e(F515 - F861)"] = ex2_MAG_APER_auto
colours_auto["e(F515 - F660)"] = ey2_MAG_APER_auto
#Color
ex3_MAG_APER_auto, ey3_MAG_APER_auto = errormag(tab_1, 'zSDSS_auto_err', 'gSDSS_auto_err', 'zSDSS_auto_err', 'J0660_auto_err')
colours_auto["e(z - g)"] = ex3_MAG_APER_auto
colours_auto["e(z - F660)"] = ey3_MAG_APER_auto
#Color
ex4_MAG_APER_auto, ey4_MAG_APER_auto = errormag(tab_1, 'J0660_auto_err', 'rSDSS_auto_err', 'gSDSS_auto_err', 'J0515_auto_err')
colours_auto["e(F660 - r)"] = ex4_MAG_APER_auto
colours_auto["e(g - F515)"] = ey4_MAG_APER_auto
#Color
ex5_MAG_APER_auto, ey5_MAG_APER_auto = errormag(tab_1, 'gSDSS_auto_err', 'iSDSS_auto', 'J0410_auto_err', 'J0660_auto_err')
colours_auto["e(g - i)"] = ex5_MAG_APER_auto
colours_auto["e(F410 - F660)"] = ey5_MAG_APER_auto

#########################################################################
#Color Aper. Second File ################################################
#########################################################################
...
#########################################################################MAG_APER_6_0
#Color vironen
x1_MAG_APER_aper_1, y1_MAG_APER_aper_1 = colour(tab_1, 'rSDSS_MAG_APER_6_0', 'iSDSS_MAG_APER_6_0', 'rSDSS_MAG_APER_6_0', 'J0660_MAG_APER_6_0')
colours1["r-i"] = x1_MAG_APER_aper_1
colours1["r-ha"] = y1_MAG_APER_aper_1
#Color
x2_MAG_APER_aper_1, y2_MAG_APER_aper_1 = colour(tab_1, 'J0515_MAG_APER_6_0', 'J0861_MAG_APER_6_0', 'J0515_MAG_APER_6_0', 'J0660_MAG_APER_6_0')
colours1["F515 - F861"] = x2_MAG_APER_aper_1
colours1["F515 - F660"] = y2_MAG_APER_aper_1
#Color
x3_MAG_APER_aper_1, y3_MAG_APER_aper_1 = colour(tab_1, 'zSDSS_MAG_APER_6_0', 'gSDSS_MAG_APER_6_0', 'zSDSS_MAG_APER_6_0', 'J0660_MAG_APER_6_0')
colours1["z - g"] = x3_MAG_APER_aper_1
colours1["z - F660"] = y3_MAG_APER_aper_1
#Color
x4_MAG_APER_aper_1, y4_MAG_APER_aper_1 = colour(tab_1, 'J0660_MAG_APER_6_0', 'rSDSS_MAG_APER_6_0', 'gSDSS_MAG_APER_6_0', 'J0515_MAG_APER_6_0')
colours1["F660 - r"] = x4_MAG_APER_aper_1
colours1["g - F515"] = y4_MAG_APER_aper_1
#Color
x5_MAG_APER_aper_1, y5_MAG_APER_aper_1 = colour(tab_1, 'gSDSS_MAG_APER_6_0', 'iSDSS_MAG_APER_6_0', 'J0410_MAG_APER_6_0', 'J0660_MAG_APER_6_0')
colours1["g - i"] = x5_MAG_APER_aper_1
colours1["F410 - F660"] = y5_MAG_APER_aper_1
#########################################################
#ERROR ##################################################
#########################################################
#Error Color vironen
ex1_MAG_APER_aper_1, ey1_MAG_APER_aper_1 = errormag(tab_1, 'rSDSS_MAG_APER_6_0_err', 'iSDSS_MAG_APER_6_0_err', 'rSDSS_MAG_APER_6_0_err', 'J0660_MAG_APER_6_0_err')
colours1["e(r-i)"] = ex1_MAG_APER_aper_1
colours1["e(r-ha)"] = ey1_MAG_APER_aper_1
#Color
ex2_MAG_APER_aper_1, ey2_MAG_APER_aper_1 = errormag(tab_1, 'J0515_MAG_APER_6_0_err', 'J0861_MAG_APER_6_0_err', 'J0515_MAG_APER_6_0_err', 'J0660_MAG_APER_6_0_err')
colours1["e(F515 - F861)"] = ex2_MAG_APER_aper_1
colours1["e(F515 - F660)"] = ey2_MAG_APER_aper_1
#Color
ex3_MAG_APER_aper_1, ey3_MAG_APER_aper_1 = errormag(tab_1, 'zSDSS_MAG_APER_6_0_err', 'gSDSS_MAG_APER_6_0_err', 'zSDSS_MAG_APER_6_0_err', 'J0660_MAG_APER_6_0_err')
colours1["e(z - g)"] = ex3_MAG_APER_aper_1
colours1["e(z - F660)"] = ey3_MAG_APER_aper_1
#Color
ex4_MAG_APER_aper_1, ey4_MAG_APER_aper_1 = errormag(tab_1, 'J0660_MAG_APER_6_0_err', 'rSDSS_MAG_APER_6_0_err', 'gSDSS_MAG_APER_6_0_err', 'J0515_MAG_APER_6_0_err')
colours1["e(F660 - r)"] = ex4_MAG_APER_aper_1
colours1["e(g - F515)"] = ey4_MAG_APER_aper_1
#Color
ex5_MAG_APER_aper_1, ey5_MAG_APER_aper_1 = errormag(tab_1, 'gSDSS_MAG_APER_6_0_err', 'iSDSS_MAG_APER_6_0', 'J0410_MAG_APER_6_0_err', 'J0660_MAG_APER_6_0_err')
colours1["e(g - i)"] = ex5_MAG_APER_aper_1
colours1["e(F410 - F660)"] = ey5_MAG_APER_aper_1
...
#Color vironen
x1_MAG_APER_auto_1, y1_MAG_APER_auto_1 = colour(tab_1, 'rSDSS_auto', 'iSDSS_auto', 'rSDSS_auto', 'J0660_auto')
colours1_auto["r-i"] = x1_MAG_APER_auto_1
colours1_auto["r-ha"] = y1_MAG_APER_auto_1
#Color
x2_MAG_APER_auto_1, y2_MAG_APER_auto_1 = colour(tab_1, 'J0515_auto', 'J0861_auto', 'J0515_auto', 'J0660_auto')
colours1_auto["F515 - F861"] = x2_MAG_APER_auto_1
colours1_auto["F515 - F660"] = y2_MAG_APER_auto_1
#Color
x3_MAG_APER_auto_1, y3_MAG_APER_auto_1 = colour(tab_1, 'zSDSS_auto', 'gSDSS_auto', 'zSDSS_auto', 'J0660_auto')
colours1_auto["z - g"] = x3_MAG_APER_auto_1
colours1_auto["z - F660"] = y3_MAG_APER_auto_1
#Color
x4_MAG_APER_auto_1, y4_MAG_APER_auto_1 = colour(tab_1, 'J0660_auto', 'rSDSS_auto', 'gSDSS_auto', 'J0515_auto')
colours1_auto["F660 - r"] = x4_MAG_APER_auto_1
colours1_auto["g - F515"] = y4_MAG_APER_auto_1
#Color
x5_MAG_APER_auto_1, y5_MAG_APER_auto_1 = colour(tab_1, 'gSDSS_auto', 'iSDSS_auto', 'J0410_auto', 'J0660_auto')
colours1_auto["g - i"] = x5_MAG_APER_auto_1
colours1_auto["F410 - F660"] = y5_MAG_APER_auto_1
#########################################################
#ERROR ##################################################
#########################################################
#Error Color vironen
ex1_MAG_APER_auto_1, ey1_MAG_APER_auto_1 = errormag(tab_1, 'rSDSS_auto_err', 'iSDSS_auto_err', 'rSDSS_auto_err', 'J0660_auto_err')
colours1_auto["e(r-i)"] = ex1_MAG_APER_auto_1
colours1_auto["e(r-ha)"] = ey1_MAG_APER_auto_1
#Color
ex2_MAG_APER_auto_1, ey2_MAG_APER_auto_1 = errormag(tab_1, 'J0515_auto_err', 'J0861_auto_err', 'J0515_auto_err', 'J0660_auto_err')
colours1_auto["e(F515 - F861)"] = ex2_MAG_APER_auto_1
colours1_auto["e(F515 - F660)"] = ey2_MAG_APER_auto_1
#Color
ex3_MAG_APER_auto_1, ey3_MAG_APER_auto_1 = errormag(tab_1, 'zSDSS_auto_err', 'gSDSS_auto_err', 'zSDSS_auto_err', 'J0660_auto_err')
colours1["e(z - g)"] = ex3_MAG_APER_auto_1
colours1_auto["e(z - F660)"] = ey3_MAG_APER_auto_1
#Color
ex4_MAG_APER_auto_1, ey4_MAG_APER_auto_1 = errormag(tab_1, 'J0660_auto_err', 'rSDSS_auto_err', 'gSDSS_auto_err', 'J0515_auto_err')
colours1_auto["e(F660 - r)"] = ex4_MAG_APER_auto_1
colours1_auto["e(g - F515)"] = ey4_MAG_APER_auto_1
#Color
ex5_MAG_APER_auto_1, ey5_MAG_APER_auto_1 = errormag(tab_1, 'gSDSS_auto_err', 'iSDSS_auto', 'J0410_auto_err', 'J0660_auto_err')
colours1_auto["e(g - i)"] = ex5_MAG_APER_auto_1
colours1_auto["e(F410 - F660)"] = ey5_MAG_APER_auto_1
...
ax.scatter(colours0["r-i"], colours0["r-ha"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100, zorder=211.0, label='All objects')
...
ax.scatter(colours1["r-i"], colours1["r-ha"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, zorder=211.0, label='Known PNe')
...
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig1-{}-vironen-v2.pdf'.format(file_.split('.ta')[0])
...
ax1.scatter(colours1["F515 - F861"], colours1["F515 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100,  zorder=211.0, label='Known PNe')
...
#ax1.grid()
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig2-{}-J0515_J0660-v2.pdf'.format(file_.split('.ta')[0])
...
ax2.scatter(colours1["z - g"], colours1["z - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100,  zorder=211.0, label='PN candidate')
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig3-{}-z-v2.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
###############################################################
...
ax4.scatter(colours1["F660 - r"], colours1["g - F515"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100,  zorder=211.0, label='PN candidate')
...
ax5.scatter(colours1["g - i"], colours1["F410 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, s=100,  zorder=211.0, label='PN candidate')
...
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig5-{}-gi-v2.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
...
ax6.set_xlim(left=-3.7,right=3.7)
ax6.set_ylim(bottom=-2.4,top=2.8)
plt.tick_params(axis='x', labelsize=22)
plt.tick_params(axis='y', labelsize=22)
plt.xlabel('$r - i$', size =22)
plt.ylabel('$r - J0660$', size =22) #edgecolor='black'
ax6.scatter(colours_auto["r-i"], colours_auto["r-ha"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100, zorder=211.0, label='SMC PNe')
#ax1.errorbar(colours_auto["r-i"], colours_auto["r-ha"], xerr=colours_auto["e(r-i)"], yerr=colours_auto["e(r-ha)"], marker='.', fmt='.', color= sns.xkcd_rgb["black"], elinewidth=0.9, markeredgewidth=0.9, capsize=3)
ax6.scatter(colours1_auto["r-i"], colours1_auto["r-ha"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, zorder=211.0, label='SMC PNe')
...
y0 =  0.43*x_new + 0.65
yy = -6.8*x_new2 - 1.3
ax6.plot(x_new, y0, color='k', linestyle='-.')
...
#ax1.grid(which='minor')#, lw=0.3)
ax6.legend(scatterpoints=1, ncol=2, fontsize=12.3, loc="lower right", **lgd_kws)
#ax.grid()
#sns.despine(bottom=True)
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig1-{}-vironen-auto-v2.pdf'.format(file_.split('.ta')[0])
# save_path = '../../../../../Dropbox/paper-pne/Fig/'
# file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
#############################################################################################
...
ax7.set_xlim(left=-5.8,right=6.4)
ax7.set_ylim(bottom=-4.5,top=5.7)
plt.tick_params(axis='x', labelsize=25)
plt.tick_params(axis='y', labelsize=25)
plt.xlabel('$J0515 - J0861$', size = 35)
plt.ylabel('$J0515 - J0660$', size = 35)
ax7.scatter(colours_auto["F515 - F861"], colours_auto["F515 - F660"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100,  zorder=211.0, label='PN candidate')
#ax7.errorbar(colours_auto["F515 - F861"], colours_auto["F515 - F660"], xerr=colours_auto["e(F515 - F861)"], yerr=colours_auto["e(F515 - F660)"], marker='.', fmt='.', color= sns.xkcd_rgb["black"], elinewidth=0.9, markeredgewidth=0.9, capsize=3)
ax7.scatter(colours1_auto["F515 - F861"], colours1_auto["F515 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100,  zorder=211.0, label='PN candidate')
...
# source_label(ax7, "", x7_np_MAG_APER_6_0_0, y1_np_MAG_APER_6_0_0, dx=-45)
# source_label(ax7, "LEDA 2790884", x7_np_MAG_APER_6_0_3, y1_np_MAG_APER_6_0_3, dx=8)
# source_label(ax7, "LEDA 101538", x7_np_MAG_APER_6_0_1, y1_np_MAG_APER_6_0_1, dx=-72)
# source_label(ax7, "PN Sp 4-1", x7_np_MAG_APER_6_0_2, y1_np_MAG_APER_6_0_2, dx=-50)
# source_label_hash(ax7, "TK 1", x7_np_hast_MAG_APER_6_0, y1_np_hast_MAG_APER_6_0, 6034, dx=4, dy=-10)
# source_label_hash(ax7, "Kn J1857.7+3931", x7_np_hast_MAG_APER_6_0, y1_np_hast_MAG_APER_6_0, 3014, dx=-50, dy=13)
# source_label_hash(ax7, "KnPa J1848.6+4151", x7_np_hast_MAG_APER_6_0, y1_np_hast_MAG_APER_6_0, 45492, dy=10)
# source_label_hash(ax7, "Jacoby 1", x7_np_hast_MAG_APER_6_0, y1_np_hast_MAG_APER_6_0, 5598, dx=-42, dy=6)
# source_label_hash_s(ax7, "Fr 2-21", x7_np_hast_ISO_GAUSS_s, y1_np_hast_ISO_GAUSS_s, dx=-36, dy=-7)

plt.text(0.05, 0.91, 'hPN zone',
         transform=ax7.transAxes, fontsize=22)
# plt.text(0.56, 0.91, 'SySt Zone',
#          transform=ax7.transAxes, color="red", fontsize=22)
# ax7.minorticks_on()

ax7.minorticks_on()
#ax7.grid(which='minor')#, lw=0.3)
#ax7.legend(scatterpoints=1, ncol=2, fontsize=12.3, loc="lower right", **lgd_kws)
#ax7.grid()
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig2-{}-J0515_J0660-auto-v2.pdf'.format(file_.split('.ta')[0])
#save_path = '../../../../../Dropbox/JPAS/paper-phot/'
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
...
ax8.set_xlim(left=-5.9,right=3.9)
ax8.set_ylim(bottom=-5.,top=5.0)
plt.tick_params(axis='x', labelsize=25)
plt.tick_params(axis='y', labelsize=25)
plt.xlabel('$z - g$', size =35)
plt.ylabel('$z - J0660$', size =35)
ax8.scatter(colours_auto["z - g"], colours_auto["z - F660"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100,  zorder=211.0, label='PN candidate')
#ax8.errorbar(colours_auto["z - g"], colours_auto["z - F660"], xerr=colours_auto["e(z - g)"], yerr=colours_auto["e(z - F660)"], marker='.', fmt='.', color= sns.xkcd_rgb["black"], elinewidth=0.9, markeredgewidth=0.9, capsize=3)
ax8.scatter(colours1_auto["z - g"], colours1_auto["z - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100,  zorder=211.0, label='PN candidate')
...
# source_label(ax8, "", x2_np_MAG_APER_6_0_0, y2_np_MAG_APER_6_0_0, dx=-42)
# source_label(ax8, "LEDA 2790884", x2_np_MAG_APER_6_0_3, y2_np_MAG_APER_6_0_3, dx=-75, dy=7)
# source_label(ax8, "LEDA 101538", x2_np_MAG_APER_6_0_1, y2_np_MAG_APER_6_0_1, dy=-8)
# source_label(ax8, "PN Sp 4-1", x2_np_MAG_APER_6_0_2, y2_np_MAG_APER_6_0_2, dx=7, dy=-5)
# source_label_hash(ax8, "TK 1", x2_np_hast_MAG_APER_6_0, y2_np_hast_MAG_APER_6_0, 6034)
# source_label_hash(ax8, "Kn J1857.7+3931", x2_np_hast_MAG_APER_6_0, y2_np_hast_MAG_APER_6_0, 3014, dx=-85, dy=-5)#, dx=-85, dy=5)
# source_label_hash(ax8, "KnPa J1848.6+4151", x2_np_hast_MAG_APER_6_0, y2_np_hast_MAG_APER_6_0, 45492, dy=-10)
# source_label_hash(ax8, "Jacoby 1", x2_np_hast_MAG_APER_6_0, y2_np_hast_MAG_APER_6_0, 5598, dx=4, dy=-10)#, dx=-45, dy=-5)
# source_label_hash_s(ax8, "Fr 2-21", x2_np_hast_ISO_GAUSS_s, y2_np_hast_ISO_GAUSS_s, dx=-36, dy=7) 

plt.text(0.58, 0.92, 'hPN zone',
         transform=ax8.transAxes, fontsize=22)
# plt.text(0.03, 0.7, 'SySt Zone',
#          transform=ax8.transAxes, color="red", fontsize=22)
# ax8.minorticks_on()

ax8.minorticks_on()
#ax7.grid(which='minor')#, lw=0.3)
#ax8.legend(scatterpoints=1, ncol=2, fontsize=12.3, loc="lower right", **lgd_kws)
#ax8.grid()
#sns.despine(bottom=True)
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig3-{}-z-auto-v2.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
###############################################################
...
ax9.set_xlim(left=-2.7,right=0.8)
ax9.set_ylim(bottom=-3.2,top=1.8)
plt.tick_params(axis='x', labelsize=25)
plt.tick_params(axis='y', labelsize=25)
plt.xlabel('$J0660 - r$', size =35)
plt.ylabel('$g - J0515$', size =35)
ax9.scatter(colours_auto["F660 - r"], colours_auto["g - F515"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100,  zorder=211.0, label='PN candidate')
#ax9.errorbar(colours_auto["F660 - r"], colours_auto["g - F515"], xerr=colours_auto["e(F660 - r)"], yerr=colours_auto["e(g - F515)"], marker='.', fmt='.', color= sns.xkcd_rgb["black"], elinewidth=0.9, markeredgewidth=0.9, capsize=3)
ax9.scatter(colours1_auto["F660 - r"], colours1_auto["g - F515"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100,  zorder=211.0, label='PN candidate')
...
plt.text(0.05, 0.07, 'hPN zone',
         transform=ax9.transAxes, fontsize=22)
plt.text(0.05, 0.92, 'SySt Zone',
         transform=ax9.transAxes, color="red", fontsize=22)
# ax9.minorticks_on()

ax9.minorticks_on()
#ax7.grid(which='minor')#, lw=0.3)
#ax9.legend(scatterpoints=1, fontsize=15.0, loc="lower right", **lgd_kws)
#ax9.grid()
#sns.despine(bottom=True)
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig4-{}-g-auto-v2.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
plt.clf()
...
ax10.set_xlim(left=-3.0,right=5.0)
ax10.set_ylim(bottom=-2.0,top=6.0)

plt.tick_params(axis='x', labelsize=25)
plt.tick_params(axis='y', labelsize=25)
plt.xlabel('$g - i$', size=35)
plt.ylabel('$J0410 - J0660$', size =35)
ax10.scatter(colours_auto["g - i"], colours_auto["F410 - F660"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, s=100,  zorder=211.0, label='PN candidate')
#ax10.errorbar(colours_auto["g - i"], colours_auto["F410 - F660"], xerr=colours_auto["e(g - i)"], yerr=colours_auto["e(F410 - F660)"],  marker='.', fmt='.', color= sns.xkcd_rgb["light orange"], elinewidth=0.9, markeredgewidth=0.9, alpha=0.3, capsize=3)
ax10.scatter(colours1_auto["g - i"], colours1_auto["F410 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, s=100,  zorder=211.0, label='PN candidate')
...
# source_label(ax10, "", x5_np_MAG_APER_6_0_0, y5_np_MAG_APER_6_0_0, dy=-4.5)
# source_label(ax10, "LEDA 2790884", x5_np_MAG_APER_6_0_3, y5_np_MAG_APER_6_0_3, dx=10, dy=-4.5)
# source_label(ax10, "LEDA 101538", x5_np_MAG_APER_6_0_1, y5_np_MAG_APER_6_0_1, dx=-65, dy=-4.5)
# source_label(ax10, "PN Sp 4-1", x5_np_MAG_APER_6_0_2, y5_np_MAG_APER_6_0_2, dx= -50, dy=-4.5)
# source_label_hash(ax10, "TK 1", x5_np_hast_MAG_APER_6_0, y5_np_hast_MAG_APER_6_0, 6034, dy=-5)
# source_label_hash(ax10, "Kn J1857.7+3931", x5_np_hast_MAG_APER_6_0, y5_np_hast_MAG_APER_6_0, 3014)#, dx=-85)
# source_label_hash(ax10, "KnPa J1848.6+4151", x5_np_hast_MAG_APER_6_0, y5_np_hast_MAG_APER_6_0, 45492, dy=10)
# source_label_hash(ax10, "Jacoby 1", x5_np_hast_MAG_APER_6_0, y5_np_hast_MAG_APER_6_0, 5598, dx=-46, dy=-5)
# source_label_hash_s(ax10, "Fr 2-21", x5_np_hast_ISO_GAUSS_s, y5_np_hast_ISO_GAUSS_s, dx=-36, dy=8)

plt.text(0.03, 0.90, 'hPN zone',
         transform=ax10.transAxes, fontsize=22)

# plt.text(0.5, 0.93, 'SySt Zone',
#          transform=ax10.transAxes,color="red", fontsize=22)

ax10.minorticks_on()
#ax7.grid(which='minor')#, lw=0.3)
#ax10.legend(scatterpoints=1, fontsize=15.0, loc='lower right', **lgd_kws)
#ax10.grid()
#sns.despine(bottom=True)
plt.tight_layout()
plt.tight_layout()
pltfile = 'figs-pca-v1/Fig5-{}-gi-auto-v2.pdf'.format(file_.split('.ta')[0])
#file_save = os.path.join(save_path, pltfile)
plt.savefig(pltfile)
