...
ax1.scatter(colours1["F515 - F861"], colours1["F515 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, edgecolor='white', zorder=211.0, label='Known PNe')
...
ax4.scatter(colours1["F660 - r"], colours1["g - F515"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
ax5.scatter(colours1["g - i"], colours1["F410 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
plt.xlabel('$r - i$', size =22)
plt.ylabel('$r - J0660$', size =22) #edgecolor='black'
ax6.scatter(colours_auto["r-i"], colours_auto["r-ha"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100, edgecolor='white', zorder=211.0, label='SMC PNe')
...
ax6.scatter(colours1_auto["r-i"], colours1_auto["r-ha"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, edgecolor='white', zorder=211.0, label='SMC PNe')
...
plt.xlabel('$J0515 - J0861$', size = 35)
plt.ylabel('$J0515 - J0660$', size = 35)
ax7.scatter(colours_auto["F515 - F861"], colours_auto["F515 - F660"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
ax7.scatter(colours1_auto["F515 - F861"], colours1_auto["F515 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
plt.xlabel('$z - g$', size =35)
plt.ylabel('$z - J0660$', size =35)
ax8.scatter(colours_auto["z - g"], colours_auto["z - F660"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
ax8.scatter(colours1_auto["z - g"], colours1_auto["z - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
plt.xlabel('$J0660 - r$', size =35)
plt.ylabel('$g - J0515$', size =35)
ax9.scatter(colours_auto["F660 - r"], colours_auto["g - F515"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, marker ='o', s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
ax9.scatter(colours1_auto["F660 - r"], colours1_auto["g - F515"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, marker ='o', s=100, edgecolor='white', zorder=211.0, label='PN candidate')
...
plt.xlabel('$g - i$', size=35)
plt.ylabel('$J0410 - J0660$', size =35)
ax10.scatter(colours_auto["g - i"], colours_auto["F410 - F660"], c=sns.xkcd_rgb['cerulean'], alpha=0.7, s=100, edgecolor='white',  zorder=211.0, label='PN candidate')
...
ax10.scatter(colours1_auto["g - i"], colours1_auto["F410 - F660"], c=sns.xkcd_rgb['dark pink'], alpha=0.8, s=100, edgecolor='white', zorder=211.0, label='PN candidate')
