...
pattern1 = "Field*/1000001-JPLUS*iSDSS*swp-crop.fits"
file_list1 = glob.glob(pattern1)

pattern2 = "Field*/1000001-JPLUS*rSDSS*swp-crop.fits"
file_list2 = glob.glob(pattern2)

pattern3 = "Field*/1000001-JPLUS*gSDSS*swp-crop.fits"
file_list3 = glob.glob(pattern3)

pattern_region = "Field*/*.reg"
