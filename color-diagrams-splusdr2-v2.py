'''
Read the file from S-PLUS IDR2 table after to apply the colour criteria to make the colour-colour diagrams
'''
...
def colour(Aper, f1, f2, f3, f4):
    ...
    n = len(Aper[f1])
    for n in range(n): 
        xcolour = Aper[f1][n] - Aper[f2][n]
        ycolour = Aper[f3][n] - Aper[f4][n]
        xcolor.append(xcolour)
        ycolor.append(ycolour)
...
tab_np_aper = Table.read("SPLUS_HYDRA_master_catalogue_iDR2_december_2019-aper-PN.tab", format="ascii.tab")
tab_np_auto = Table.read("SPLUS_HYDRA_master_catalogue_iDR2_december_2019-auto-PN.tab", format="ascii.tab")
...
#Calor Aper 3 ################################################################################
#Color vironen
x_np_MAG_APER_3, y_np_MAG_APER_3 = colour(tab_np_aper, 'r_aper', 'i_aper', 'r_aper', 'F660_aper')
#Color
x1_np_MAG_APER_3, y1_np_MAG_APER_3 = colour(tab_np_aper, 'F515_aper', 'F861_aper', 'F515_aper', 'F660_aper')
#Color
x2_np_MAG_APER_3, y2_np_MAG_APER_3 = colour(tab_np_aper, 'z_aper', 'g_aper', 'z_aper', 'F660_aper')
#Color
x3_np_MAG_APER_3, y3_np_MAG_APER_3 = colour(tab_np_aper, 'F660_aper', 'r_aper', 'F660_aper', 'g_aper')
#Color
x4_np_MAG_APER_3, y4_np_MAG_APER_3 = colour(tab_np_aper, 'F660_aper', 'r_aper', 'g_aper', 'F515_aper')
#Color
x5_np_MAG_APER_3, y5_np_MAG_APER_3 = colour(tab_np_aper, 'g_aper', 'i_aper', 'F410_aper', 'F660_aper')
...
#########################################################################
#Color vironen
x_np_MAG_APER_auto, y_np_MAG_APER_auto = colour(tab_np_auto, 'r_auto', 'i_auto', 'r_auto', 'F660_auto')
#Color
x1_np_MAG_APER_auto, y1_np_MAG_APER_auto = colour(tab_np_auto, 'F515_auto', 'F861_auto', 'F515_auto', 'F660_auto')
#Color
x2_np_MAG_APER_auto, y2_np_MAG_APER_auto = colour(tab_np_auto, 'z_auto', 'g_auto', 'z_auto', 'F660_auto')
#Color
x3_np_MAG_APER_auto, y3_np_MAG_APER_auto = colour(tab_np_auto, 'F660_auto', 'r_auto', 'F660_auto', 'g_auto')
#Color
x4_np_MAG_APER_auto, y4_np_MAG_APER_auto = colour(tab_np_auto, 'F660_auto', 'r_auto', 'g_auto', 'F515_auto')
#Color
x5_np_MAG_APER_auto, y5_np_MAG_APER_auto = colour(tab_np_auto, 'g_auto', 'i_auto', 'F410_auto', 'F660_auto')
...
#########################################################################
#Color vironen
x_np_MAG_APER_petro, y_np_MAG_APER_petro = colour(tab_np_petro, 'r_petro', 'i_petro', 'r_petro', 'F660_petro')
#Color
x1_np_MAG_APER_petro, y1_np_MAG_APER_petro = colour(tab_np_petro, 'F515_petro', 'F861_petro', 'F515_petro', 'F660_petro')
#Color
x2_np_MAG_APER_petro, y2_np_MAG_APER_petro = colour(tab_np_petro, 'z_petro', 'g_petro', 'z_petro', 'F660_petro')
#Color
x3_np_MAG_APER_petro, y3_np_MAG_APER_petro = colour(tab_np_petro, 'F660_petro', 'r_petro', 'F660_petro', 'g_petro')
#Color
x4_np_MAG_APER_petro, y4_np_MAG_APER_petro = colour(tab_np_petro, 'F660_petro', 'r_petro', 'g_petro', 'F515_petro')
#Color
x5_np_MAG_APER_petro, y5_np_MAG_APER_petro = colour(tab_np_petro, 'g_petro', 'i_petro', 'F410_petro', 'F660_petro')
