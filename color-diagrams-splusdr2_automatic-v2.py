...
#########################################################################
#Color vironen
x1_MAG_APER_pstotal, y1_MAG_APER_pstotal = colour(tab_, 'R_PStotal', 'I_PStotal', 'R_PStotal', 'F660_PStotal')
colours_pstotal["r-i"] = x1_MAG_APER_pstotal
colours_pstotal["r-ha"] = y1_MAG_APER_pstotal
#Color
x2_MAG_APER_pstotal, y2_MAG_APER_pstotal = colour(tab_, 'F515_PStotal', 'F861_PStotal', 'F515_PStotal', 'F660_PStotal')
colours_pstotal["F515 - F861"] = x2_MAG_APER_pstotal
colours_pstotal["F515 - F660"] = y2_MAG_APER_pstotal
#Color
x3_MAG_APER_pstotal, y3_MAG_APER_pstotal = colour(tab_, 'Z_PStotal', 'G_PStotal', 'Z_PStotal', 'F660_PStotal')
colours_pstotal["z - g"] = x3_MAG_APER_pstotal
colours_pstotal["z - F660"] = y3_MAG_APER_pstotal
#Color
x4_MAG_APER_pstotal, y4_MAG_APER_pstotal = colour(tab_, 'F660_PStotal', 'R_PStotal', 'G_PStotal', 'F515_PStotal')
colours_pstotal["F660 - r"] = x4_MAG_APER_pstotal
colours_pstotal["g - F515"] = y4_MAG_APER_pstotal
#Color
x5_MAG_APER_pstotal, y5_MAG_APER_pstotal = colour(tab_, 'G_PStotal', 'I_PStotal', 'F410_PStotal', 'F660_PStotal')
colours_pstotal["g - i"] = x5_MAG_APER_pstotal
colours_pstotal["F410 - F660"] = y5_MAG_APER_pstotal
#########################################################
#ERROR ##################################################
#########################################################
#Error Color vironen
ex1_MAG_APER_pstotal, ey1_MAG_APER_pstotal = errormag(tab_, 'e_R_PStotal', 'e_I_PStotal', 'e_R_PStotal', 'e_F660_PStotal')
colours_pstotal["e(r-i)"] = ex1_MAG_APER_pstotal
colours_pstotal["e(r-ha)"] = ey1_MAG_APER_pstotal
#Color
ex2_MAG_APER_pstotal, ey2_MAG_APER_pstotal = errormag(tab_, 'e_F515_PStotal', 'e_F861_PStotal', 'e_F515_PStotal', 'e_F660_PStotal')
colours_pstotal["e(F515 - F861)"] = ex2_MAG_APER_pstotal
colours_pstotal["e(F515 - F660)"] = ey2_MAG_APER_pstotal
#Color
ex3_MAG_APER_pstotal, ey3_MAG_APER_pstotal = errormag(tab_, 'e_Z_PStotal', 'e_G_PStotal', 'e_Z_PStotal', 'e_F660_PStotal')
colours_pstotal["e(z - g)"] = ex3_MAG_APER_pstotal
colours_pstotal["e(z - F660)"] = ey3_MAG_APER_pstotal
#Color
ex4_MAG_APER_pstotal, ey4_MAG_APER_pstotal = errormag(tab_, 'e_F660_PStotal', 'e_R_PStotal', 'e_G_PStotal', 'e_F515_PStotal')
colours_pstotal["e(F660 - r)"] = ex4_MAG_APER_pstotal
colours_pstotal["e(g - F515)"] = ey4_MAG_APER_pstotal
#Color
ex5_MAG_APER_pstotal, ey5_MAG_APER_pstotal = errormag(tab_, 'e_G_PStotal', 'e_I_PStotal', 'e_F410_PStotal', 'e_F660_PStotal')
colours_pstotal["e(g - i)"] = ex5_MAG_APER_pstotal
colours_pstotal["e(F410 - F660)"] = ey5_MAG_APER_pstotal
